gAuthenticator.controller("todoListSettingsCtrl", ["$scope", "$location", "todoService", "$routeParams", "oiSelect", "$timeout", function ($scope, $location, todoService, $routeParams, rootScope, oiSelect, $timeout) {
